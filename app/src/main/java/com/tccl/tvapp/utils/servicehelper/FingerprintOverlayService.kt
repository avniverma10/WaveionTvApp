package com.tccl.tvapp.utils.servicehelper
...
import com.tccl.tvapp.extensions.generateTextFingerprint
import com.tccl.tvapp.model.data.sseresponse.Fingerprint
...
class FingerprintOverlayService : Service() {
    ...
    private fun updateAllFingerprints(fps: List<Fingerprint>) {
        if (WTVAppTccl.Companion.isInForeground) {
            clearAllOverlays()
            return
        }
        ...
        fps.forEach { fp ->
            val intervalMillis = (fp.intervalSec ?: 5) * 1_000L
