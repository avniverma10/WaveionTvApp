package com.tccl.tvapp.model.data.epgdata
...
class ProgramTimestampAdapter :  JsonDeserializer<Long> {
    override fun deserialize(
        ...
        return try {
            ...
            // Build two Calendars: one for 'now', one for our event (time of day)
            ...
            // If that event time is already past today, move it to tomorrow
