...
class WidevineMediaDrmCallback(
    ...
    private fun getCustomData(): String {
        ...
        customData.put("userId", "rrishi")
        customData.put("sessionId", "12345678")
        ...
        // }
        return Base64.encodeToString(customData.toString().toByteArray(), Base64.NO_WRAP)
    }
}
